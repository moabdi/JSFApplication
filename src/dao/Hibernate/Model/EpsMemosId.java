...
/**
 * EpsMemosId generated by hbm2java
 */
public class EpsMemosId implements java.io.Serializable {
	...
	public EpsMemosId(String userCode, String subject) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EpsMemosId))
			return false;
		EpsMemosId castOther = (EpsMemosId) other;
