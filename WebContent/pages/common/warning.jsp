					...
					<f:facet name="header">
						<h:panelGroup>
							<table width="15%" border="0" >
								<tr>
									<td width="5%"><h:graphicImage value="/images/warning.gif"
										style="left: 0px" /></td>
									<td width="10%"><h:outputText value="WARNING"
										style="color: yellow ; font-size: 14px" /></td>
								</tr>
							</table>
						</h:panelGroup>
					</f:facet>
					<center><br>
					<h:outputText value="Please Enter Your Username & Password" style="font-size: 18px"></h:outputText><br>
					<br>
					<h:commandLink value="Login" action="#{loginBean.pass}"
