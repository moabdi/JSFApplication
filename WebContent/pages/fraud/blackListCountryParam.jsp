			...
			<tr>
				...
				<table class="titrePage" width="100%">
								...
								<table width="100%" class="ident" style="">
									<tr>
										<td width="54%" align="left"><h:outputLabel
											value="#{msg.Fraude_Black_List}" /></td>
											<td width="40%" align="right"><h:outputText
											value="#{msg.Gen_Add}"
											rendered="#{blackListCountryBBean.addStatus}" /> <h:outputText
											value="#{msg.Gen_Modify}"
											rendered="#{blackListCountryBBean.modifyStatus}" /></td>
										<td width="1%">&nbsp;</td>
					...
					<tr>
											...
											<table width="100%">
												...
												<tr>
													<td class="instance" width="20%"><h:outputLabel
														value="#{msg.Accounts_Accounts_Customer_country}" /><h:outputLabel
														style="color:red" value="#{msg.Gen_RequireField}" /></td>
													<td width="30%"><h:selectOneMenu id="country_code" disabled="#{blackListCountryBBean.modifyStatus}"
														value="#{blackListCountryBBean.countryCode}" required="true" requiredMessage="#{msg.Accounts_Accounts_Customer_country} #{msg.Gen_required}" styleClass="Fixed">
														<f:selectItem itemLabel="#{msg.Gen_Select}" itemValue="" />
														<f:selectItems value="#{blackListCountryBBean.currencyCountryListSI}" />
													...
													<h:outputLabel styleClass="codelbl" id="lbl_countryCode" value="#{blackListCountryBBean.countryCode}"></h:outputLabel></td>
													<td class="instance" width="20%"><h:outputLabel
														value="#{msg.Gen_Wording}" /><h:outputLabel
														style="color:red" value="#{msg.Gen_RequireField}" /></td>
													<td width="30%"><h:inputText id="wordin" value="#{blackListCountryBBean.wording}"  autocomplete="off"
															...
															<table width="100%" class="buttonPanel">
																<tr>
																	...
																	<td><a4j:commandButton value="Back"
																		actionListener="#{blackListCountryBBean.checkChanges}"
																		action="#{blackListCountryBBean.back}"
																		oncomplete="#{blackListCountryBBean.backPanel}"
																		image="#{facesContext.externalContext.requestContextPath}/images/button_back.png"
																		immediate="#{blackListCountryBBean.immediate}"></a4j:commandButton></td>

																	<td><h:commandButton value="Add"
																		action="#{blackListCountryBBean.ToAddRecord}"
																		image="#{facesContext.externalContext.requestContextPath}/images/button_add.png"
																		rendered="#{blackListCountryBBean.modifyStatus}">
																	</h:commandButton></td>

																	<td><h:commandButton value="Duplicate"
																		action="#{blackListCountryBBean.ToDuplicateRecord}"
																	...
																	<td><a4j:commandButton value="Validate"
																		...
																		<a4j:poll id="poll" ajaxSingle="true"
																			action="#{blackListCountrySearchBBean.back}"
																			oncomplete="Richfaces.hideModalPanel('validatePanel')"
																			interval="2000"
																			enabled="#{blackListCountryBBean.pollEnabled}"
						...
						</tr></table></td></tr></table></td></tr></table></a4j:form>
	</body>
				...
				<table width=100% class="tile" align="center">
					...
					<tr>
						<td align="center" width="50%"><h:commandButton
							value="#{msg.Gen_yes}" action="#{blackListCountrySearchBBean.back}"
		...
		<rich:modalPanel id="deletePanel" style="background-color: #BAD9EF"
			...
			<h:form>
				...
				<table class="tile" width=100%>
					...
					<tr>
						<td align="center" width="50%"><a4j:commandButton
							value="#{msg.Gen_yes}" action="#{blackListCountryBBean.delete}"
