							...
							<tr>
								...
								<table width="100%" class="ident" style="">
									...
									<td width="54%" align="left"><h:outputText
										value="#{msg.Mcc_Exluding}" /></td>
									<td width="40%" align="right"><h:outputText
										value="#{msg.Gen_Add}"
										rendered="#{MccExcludingBBean.addStatus}" /> <h:outputText
										value="#{msg.Gen_Modify}"
										rendered="#{MccExcludingBBean.modifyStatus}" /></td>
									<td width="1%">&nbsp;</td>
										...
										<tr>
											...
											<table width="100%">
												...
												<td class="instance" width="20%"><h:outputLabel
													...
													<td width="30%"><h:selectOneMenu id="country_code" disabled="#{MccExcludingBBean.modifyStatus}"
														value="#{MccExcludingBBean.mccCode}" required="true" requiredMessage="#{msg.Gen_mcc} #{msg.Gen_required}" styleClass="Fixed">
													...
													<h:outputLabel styleClass="codelbl" id="lbl_countryCode" value="#{MccExcludingBBean.mccCode}"></h:outputLabel></td>
													<td class="instance" width="20%"><h:outputLabel
														value="#{msg.Gen_Wording}" /><h:outputLabel
														style="color:red" value="#{msg.Gen_RequireField}" /></td>
													<td width="30%"><h:inputText id="wordin" value="#{MccExcludingBBean.wording}"  autocomplete="off"
															...
															<table width="100%" class="buttonPanel">
																<tr>
																	...
																	<td><a4j:commandButton value="Back"
																		actionListener="#{MccExcludingBBean.checkChanges}"
																		action="#{MccExcludingBBean.back}"
																		oncomplete="#{MccExcludingBBean.backPanel}"
																		image="#{facesContext.externalContext.requestContextPath}/images/button_back.png"
																		immediate="#{MccExcludingBBean.immediate}"></a4j:commandButton></td>

																	<td><h:commandButton value="Add"
																		action="#{MccExcludingBBean.ToAddRecord}"
																		image="#{facesContext.externalContext.requestContextPath}/images/button_add.png"
																		rendered="#{MccExcludingBBean.modifyStatus}">
																	</h:commandButton></td>

																	<td><h:commandButton value="Duplicate"
																		action="#{MccExcludingBBean.ToDuplicateRecord}"
																	...
																	<td><a4j:commandButton value="Validate"
																		...
																		<a4j:poll id="poll" ajaxSingle="true"
																			action="#{MccExcludingSearchBBean.back}"
																			oncomplete="Richfaces.hideModalPanel('validatePanel')"
																			interval="2000"
																			enabled="#{MccExcludingBBean.pollEnabled}"
				...
				<table width=100% class="tile" align="center">
					...
					<tr>
						...
						<td align="center" width="50%"><h:commandButton
							...
							style=" width : 67px; height : 19px;" /></td>
	...
	<h:form>
			...
			<table class="tile" width=100%>
				...
				<tr>
					...
					<td align="center" width="50%"><a4j:commandButton
						value="#{msg.Gen_yes}" action="#{MccExcludingBBean.delete}"
