				...
				<table class="titrePage" width="100%">
								...
								<table width="100%" class="ident" style="">
									<tr>
										...
										<td width="40%" align="right"><h:outputText
											value="#{msg.Gen_Add}"
											rendered="#{StatusCardTrxFraudBBean.addStatus}" /> <h:outputText
											value="#{msg.Gen_Modify}"
											rendered="#{StatusCardTrxFraudBBean.modifyStatus}" /></td>
										<td width="1%">&nbsp;</td>
									</tr>
								</table>
					...
					<tr>
						...
						<rich:messages id="msg" showDetail="true" showSummary="false"  infoClass="infoMessage"
							errorClass="errorMessage" layout="list"></rich:messages>
					</a4j:region></td>
					<tr>
						<td>
						<table width="100%">
									...
									<tbody>
										<tr>
											...
											<table width="100%">
												...
												<td width="30%"><h:selectOneMenu required="true" requiredMessage="#{msg.Gen_bankCode} #{msg.Gen_required}" styleClass="Fixed"
													id="bank_code" value="#{StatusCardTrxFraudBBean.bankCode}"
													disabled="#{StatusCardTrxFraudBBean.modifyStatus}">
												...
												</h:selectOneMenu> <h:outputLabel styleClass="codelbl" id="lbl_bank_code" value="#{StatusCardTrxFraudBBean.bankCode}" /> 
													<rich:message for="bank_code" styleClass="warnningMessage" />
													</td>
													
													<td class="instance" width="20%"><h:outputLabel
														value="#{msg.Status_card_trx_fraud}" /><h:outputLabel
														style="color:red" value="#{msg.Gen_RequireField}" /></td>
													<td width="30%"><h:selectOneMenu disabled="#{StatusCardTrxFraudBBean.modifyStatus}" id="trx_fraud"
														value="#{StatusCardTrxFraudBBean.cardStatus}"
														required="true" requiredMessage="#{msg.Status_card_trx_fraud} #{msg.Gen_required}">
														<f:selectItem itemLabel="#{msg.Gen_Select}" itemValue="" />
														<f:selectItems value="#{applicationLists.cardStatusListSI}" />
														<a4j:support event="onchange" ajaxSingle="true"  reRender="lbl_cardStatus"/>
											
														<rich:ajaxValidator event="onblur"></rich:ajaxValidator>
													</h:selectOneMenu> 
													<rich:message styleClass="warnningMessage" for="trx_fraud"/>
													<h:outputLabel styleClass="codelbl" id="lbl_cardStatus" value="#{StatusCardTrxFraudBBean.cardStatus}"/>
													</td>
													
												</tr>
												<tr>
											<td class="instance" width="159"><h:outputLabel value="#{msg.Number_trx}"/></td>
												<td><h:inputText  value="#{StatusCardTrxFraudBBean.numberTrx}" size="4" maxlength="4">
												</h:inputText>
												</td>
												...
												<td class="instance" width="20%"><h:outputLabel
													...
													<td width="30%"><h:inputText required="true" requiredMessage="#{msg.Gen_wording} #{msg.Gen_required}"
														value="#{StatusCardTrxFraudBBean.wording}" autocomplete="off"
														size="30" maxlength="30" id="wordin">
														<rich:ajaxValidator event="onblur"></rich:ajaxValidator>
													</h:inputText>
													 <rich:message styleClass="warnningMessage" for="wordin"/>
													</td>
															...
															<table width="100%" class="buttonPanel">
																<tr>
																	...
																	<td><a4j:commandButton value="Back"
																		actionListener="#{StatusCardTrxFraudBBean.checkChanges}"
																		action="#{StatusCardTrxFraudBBean.back}"
																		oncomplete="#{StatusCardTrxFraudBBean.backPanel}"
																		image="#{facesContext.externalContext.requestContextPath}/images/button_back.png"
																		immediate="#{StatusCardTrxFraudBBean.immediate}"></a4j:commandButton></td>

																	<td><h:commandButton value="Add"
																		action="#{StatusCardTrxFraudBBean.ToAddRecord}"
																		image="#{facesContext.externalContext.requestContextPath}/images/button_add.png"
																		rendered="#{StatusCardTrxFraudBBean.modifyStatus}">
																	</h:commandButton></td>

																	<td><h:commandButton value="Duplicate"
																		action="#{StatusCardTrxFraudBBean.ToDuplicateRecord}"
																	...
																	<td><h:commandButton value="Refresh" immediate="true"
																		action="#{StatusCardTrxFraudBBean.refresh}"
																		image="#{facesContext.externalContext.requestContextPath}/images/button_refresh.png"
																		rendered="#{StatusCardTrxFraudBBean.addStatus}">
																	...
																	<td><a4j:commandButton value="Validate"
																		...
																		<a4j:poll id="poll" ajaxSingle="true"
																			action="#{StatusCardTrxFraudSearchBB.back}"
																			oncomplete="Richfaces.hideModalPanel('validatePanel')"
																			interval="2000"
																			enabled="#{StatusCardTrxFraudBBean.pollEnabled}"
	...
	<h:form>
			...
			<table class="tile" width=100%>
				...
				<tr>
					...
					<td align="center" width="50%"><a4j:commandButton
						value="#{msg.Gen_yes}" action="#{StatusCardTrxFraudBBean.delete}"
