										...
										<tr>
											...
											<table width="100%">
												...
												<tr>
													<td class="instance" width="20%"><h:outputLabel
														value="#{msg.Accounts_Accounts_Customer_country}" /></td>
													<td width="30%"><h:selectOneMenu 
														value="#{blackListCountrySearchBBean.countryCode}" >
													...
													<td width="30%"><h:inputText value="#{blackListCountrySearchBBean.wording}" size="30" maxlength="30" autocomplete="off" >
													</h:inputText></td>
												</tr>
											...
											<table width="100%">
												...
												<td align="left"><br><h:commandButton value="Refresh"
													action="#{blackListCountrySearchBBean.Refresh}"
												...
												<td align="left" ><br><h:commandButton value="Search"
													action="#{blackListCountrySearchBBean.search}"
						...
						<td>
												...
												<h:panelGrid border="1" columns="1" width="#{GlobalVars.EPS_DATATABLE_SIZE}"
													...
													<rich:panel styleClass="tiletable"
														...
														<rich:column headerClass="dataTableHeader" sortable="true"
															...
															<f:facet name="header">
																<h:outputLabel
																	value="#{msg.Accounts_Accounts_Customer_country}" />
															</f:facet>
																<h:commandLink styleClass="tableCommandLink" 
																	...
																	<h:selectOneMenu 	disabled="true" value="#{event.countryCode}"> 
														...
														<rich:column sortBy="#{event.wording}"
															...
															sortable="true">
															<f:facet name="header">
																<h:outputLabel value="#{msg.branchParam_Wording}" />
															</f:facet>
															<h:commandLink styleClass="tableCommandLink"
																	actionListener="#{blackListCountrySearchBBean.selectId}"
																	action="#{blackListCountrySearchBBean.forwardModify}">
															<h:inputText  styleClass="inputTextLink"   value="#{event.wording}" size="50" />
																</h:commandLink>
														</rich:column>
</rich:dataTable>
							...
							<table width="100%" class="buttonPanel">
								...
								<tr>
									...
									<h:outputText value="#{blackListCountrySearchBBean.alertMsg}"
										 escape="false"
										rendered="#{blackListCountrySearchBBean.render}" />
								</tr>
