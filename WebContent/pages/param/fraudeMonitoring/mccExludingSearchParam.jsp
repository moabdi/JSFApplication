										...
										<tr>
											...
											<table width="100%">
												...
												<tr>
													...
													<td width="30%"><h:selectOneMenu value="#{MccExcludingSearchBBean.mccCode}">
													...
													<td width="30%"><h:inputText
														value="#{MccExcludingSearchBBean.wording}" autocomplete="off" maxlength="30" size="30" >
													</h:inputText></td>
												</tr>
												...
												<h:panelGrid border="1" columns="1" width="#{GlobalVars.EPS_DATATABLE_SIZE}"
													...
													<rich:panel styleClass="tiletable"
														...
														<rich:dataTable id="sampleData" rows="#{GlobalVars.EPS_DATATABLE_MAX}"
															value="#{MccExcludingSearchBBean.criteria}"
															var="event"
															binding="#{MccExcludingSearchBBean.datable}"
															...
															<rich:column sortBy="#{event.wording}"
																...
																<h:commandLink styleClass="tableCommandLink"
																	actionListener="#{MccExcludingSearchBBean.selectId}"
																	action="#{MccExcludingSearchBBean.forwardModify}">
							...
							<table width="100%" class="buttonPanel">
								...
								<tr>
									...
									<td align="left"><h:commandButton value="Back"
										action="#{MccExcludingSearchBBean.backToWelcomPage}"
									...
									<td align="left"><h:commandButton value="Add"
										action="#{MccExcludingSearchBBean.addRecord}"
										image="#{facesContext.externalContext.requestContextPath}/images/button_add.png"></h:commandButton></td>
									<h:outputText value="#{MccExcludingSearchBBean.alertMsg}"
										escape="false"
										rendered="#{MccExcludingSearchBBean.render}" />
								</tr>
