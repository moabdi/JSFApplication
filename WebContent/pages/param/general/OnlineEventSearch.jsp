							...
							<table width="100%" class="ident">
								<tr>
									...
									<td width="40%" align="right"><h:outputText
										value="#{msg.online_event_search}" /></td>
									<td width="1%">&nbsp;</td>
								</tr>
										...
										<table width="100%">
											<tr>
												<td class="instance" width="20%"><h:outputText
													value="#{msg.online_event_code}" /></td>
												<td width="30%"><h:inputText id="processing_code"
													value="#{onlineEventSearchBB.eventCode}" size="3" maxlength="3">
												...
												<td width="30%"><h:inputText value="#{onlineEventSearchBB.wording}"
											...
											<tr>
												<td width="60%"></td>
												<td align="left" ><h:commandButton value="Refresh" action="#{onlineEventSearchBB.Refresh}" image="#{facesContext.externalContext.requestContextPath}/images/button_refresh.png"></h:commandButton></td>
												<td align="left" ><h:commandButton value="Search" action="#{onlineEventSearchBB.search}" image="#{facesContext.externalContext.requestContextPath}/images/button_search.png"></h:commandButton></td>
											</tr>
										</table>
										</td>
									</tr>
								...
								<tbody>
									<tr>
										...
										<td align="center">	<h:panelGrid border="1" columns="1" width="#{GlobalVars.EPS_DATATABLE_SIZE}"
												...
												<rich:dataTable id="sampleData" rows="#{GlobalVars.EPS_DATATABLE_MAX}" value="#{onlineEventSearchBB.criteria}" var="event"
													binding="#{onlineEventSearchBB.datable}"
													sortMode="single"
													...
													<rich:column headerClass="dataTableHeader" sortable="true"
														sortBy="#{event.eventCode}"
														filterBy="#{event.eventCode}" filterEvent="onblur"
														styleClass="tile" >

														<f:facet name="header">
															<h:outputText
																value="#{msg.online_event_code}" />
														</f:facet>
														<h:commandLink styleClass="tableCommandLink"
															actionListener="#{onlineEventSearchBB.selectId}"
															action="#{onlineEventSearchBB.forwardModify}">
															<h:inputText value="#{event.eventCode}"
							...
							<table width="100%" class="buttonPanel">
								...
								<tr>
									...
									<td align="left"><h:commandButton value="Back"
										action="#{onlineEventSearchBB.backToWelcomPage}"
									...
									<td align="left"><h:commandButton value="Add"
										action="#{onlineEventSearchBB.addRecord}"
										image="#{facesContext.externalContext.requestContextPath}/images/button_add.png"></h:commandButton></td>
									<h:outputText value="#{onlineEventSearchBB.alertMsg}"
										escape="false" rendered="#{onlineEventSearchBB.render}" />
								</tr>
