										...
										<table width="100%">
											<tr>
												<td class="instance" width="20%"><h:outputText
													value="#{msg.message_type}" /></td>
												<td width="30%"><h:inputText id="processing_code"
													value="#{messageSearchBB.messageType}" size="4" maxlength="4">
												...
												<td width="30%"><h:inputText value="#{messageSearchBB.wording}"
												size="25" maxlength="25"></h:inputText></td>
											</tr>
											...
											<tr>
												<td width="60%"></td>
												<td align="left" ><h:commandButton value="Refresh" action="#{messageSearchBB.Refresh}" image="#{facesContext.externalContext.requestContextPath}/images/button_refresh.png"></h:commandButton></td>
												<td align="left" ><h:commandButton value="Search" action="#{messageSearchBB.search}" image="#{facesContext.externalContext.requestContextPath}/images/button_search.png"></h:commandButton></td>
											</tr>
										</table>
										</td>
									</tr>
								...
								<tbody>
									<tr>
										...
										<td align="center">	<h:panelGrid border="1" columns="1" width="#{GlobalVars.EPS_DATATABLE_SIZE}"
												...
												<rich:dataTable id="sampleData" rows="#{GlobalVars.EPS_DATATABLE_MAX}" value="#{messageSearchBB.criteria}" var="event"
													binding="#{messageSearchBB.datable}"
													sortMode="single"
													...
													<rich:column headerClass="dataTableHeader" sortable="true"
														sortBy="#{event.messageType}"
														filterBy="#{event.messageType}" filterEvent="onblur"
														styleClass="tile" >
														...
														<h:commandLink styleClass="tableCommandLink"
															actionListener="#{messageSearchBB.selectId}"
															action="#{messageSearchBB.forwardModify}">
															<h:inputText value="#{event.messageType}"
							...
							<table width="100%" class="buttonPanel">
								...
								<tr>
									...
									<td align="left"><h:commandButton value="Back"
										action="#{messageSearchBB.backToWelcomPage}"
									...
									<td align="left"><h:commandButton value="Add"
										action="#{messageSearchBB.addRecord}"
										image="#{facesContext.externalContext.requestContextPath}/images/button_add.png"></h:commandButton></td>
									<h:outputText value="#{messageSearchBB.alertMsg}"
										escape="false" rendered="#{messageSearchBB.render}" />
								</tr>
