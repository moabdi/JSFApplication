							...
							<table width="100%" class="ident">
								<tr>
									...
									<td width="40%" align="right"><h:outputText
										value="#{msg.Gen_Add}"
										rendered="#{DaysOffBB.addStatus}" /> <h:outputText
										value="#{msg.Gen_Modify}"
										rendered="#{DaysOffBB.modifyStatus}" /></td>
									<td width="1%">&nbsp;</td>
								</tr>
							</table>
							</td>
										...
										<table width="100%">
											<tr>
												<td class="instance" width="20%"><h:outputText
													value="#{msg.countryC}" /><h:outputLabel
														style="color:red" value="#{msg.Gen_RequireField}" /></td>
												<td width="30%"><h:selectOneMenu value="#{DaysOffBB.countryCode}" required="true" requiredMessage="#{msg.countryC} #{msg.Gen_required}"
												disabled="#{DaysOffBB.modifyStatus}">
												<f:selectItem itemLabel="#{msg.Gen_Select}"/>
												<f:selectItems value="#{applicationLists.countryListSI}"/>

													<rich:ajaxValidator event="onblur" />
												</h:selectOneMenu> <rich:message for="center_code"
													styleClass="warnningMessage" /></td>
												
												
												<td class="instance" width="20%"><h:outputText
													value="#{msg.dayo}" /></td>
												<td width="30%"><rich:inputNumberSpinner value="#{DaysOffBB.dayOff}"
												required="true" minValue="1" maxValue="31" step="1"></rich:inputNumberSpinner>
												</td>
											<tr>
										</table>
										</td>
									...
									<tr>
										...
										<table width="100%">
											<tr>
												...
												<td class="instance" width="20%"><h:outputText value="#{msg.month}" /></td>
												<td width="30%"><rich:inputNumberSpinner value="#{DaysOffBB.month}"
												required="true" minValue="1" maxValue="12" step="1"></rich:inputNumberSpinner>
												
												<td class="instance" width="20%"><h:outputText
													value="#{msg.year}" /></td>
												<td width="30%"><rich:inputNumberSpinner required="true" value="#{DaysOffBB.year}"
												minValue="2009" maxValue="3000" step="1">
								...
								<tr>
									...
									<td><a4j:commandButton value="Validate"
										...
										<a4j:poll id="poll" ajaxSingle="true"
											...
											interval="2000" enabled="#{DaysOffBB.pollEnabled}"
				...
				<table width=100% class="tile" align="center">
					...
					<tr>
						...
						<td align="center" width="50%"><h:commandButton
							value="#{msg.Gen_yes}" action="#{daysOffSearchBB.back}"
			...
			<h:form>
				...
				<table class="tile" width=100%>
					...
					<tr>
						<br>
						<td align="center" width="50%"><a4j:commandButton
							value="#{msg.Gen_yes}" action="#{DaysOffBB.delete}"
