			...
			<table class="titrePage" width="50%">
							...
							<table width="100%" class="ident">
								<tr>
									<td width="54%" align="left"><h:outputText
										value="#{msg.processingParam_processingParam}" /></td>
									<td width="40%" align="right"><h:outputText
										value="#{msg.processingParam_addProcessing}"
										rendered="#{processingBackingBean.addStatus}" /> <h:outputText
										value="#{msg.processingParam_modifyProcessing}"
										rendered="#{processingBackingBean.modifyStatus}" /></td>
									<td width="1%">&nbsp;</td>
								</tr>
							</table>
							</td>
										...
										<table width="100%">
											<tr>
												<td class="instance" width="20%"><h:outputText
													value="#{msg.processingParam_ProcessingCode}" /><h:outputLabel
														style="color:red" value="#{msg.Gen_RequireField}" /></td>
												<td width="30%"><h:inputText id="processing_code" required="true" requiredMessage="#{msg.processingParam_ProcessingCode} #{msg.Gen_required}"
													value="#{processingBackingBean.processingCode}"
													disabled="#{processingBackingBean.modifyStatus}" size="2"
													maxlength="2">
												...
												<td width="30%"><h:inputText id="prowording"
													value="#{processingBackingBean.wording}" size="32" 
													maxlength="30"><rich:ajaxValidator event="onblur" />
													</h:inputText> <rich:message for="prowording"
													styleClass="warnningMessage" /></td>
											<tr>
										</table>
										</td>
				...
				<table width="100%">
					...
					<table width="100%" class="buttonPanel">
						<tr>
							...
							<td><a4j:commandButton value="Validate"
								...
								<a4j:poll id="poll" ajaxSingle="true"
									action="#{processingSearchBB.back}"
									oncomplete="Richfaces.hideModalPanel('validatePanel')"
									interval="2000" enabled="#{processingBackingBean.pollEnabled}"
						...
						<h:outputText value="#{processingBackingBean.alertMsg}"
							escape="false" rendered="#{processingBackingBean.render}" />
				...
				<table width=100% class="tile" align="center">
					...
					<tr>
						...
						<td align="center" width="50%"><h:commandButton
							value="#{msg.Gen_yes}" action="#{processingSearchBB.back}"
			...
			<h:form>
				...
				<table class="tile" width=100%>
					...
					<tr>
						<br>
						<td align="center" width="50%"><a4j:commandButton
							value="#{msg.Gen_yes}" action="#{processingBackingBean.delete}"
