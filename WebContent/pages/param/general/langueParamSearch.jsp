										...
										<table width="100%">
											<tr>
												<td class="instance" width="20%"><h:outputText
													value="#{msg.langueParam_LangueCode}" /></td>
												<td width="30%"><h:inputText id="langue_code"
													value="#{LangueSearchBB.langueCode}" size="3" maxlength="3">
												...
												<td width="30%"><h:inputText
													value="#{LangueSearchBB.wording}" size="30" maxlength="30"></h:inputText></td>
											<tr>
											<tr>
												<td></td>
												<td></td></tr>
										...
										<h:panelGrid border="1" columns="1" width="#{GlobalVars.EPS_DATATABLE_SIZE}"
												...
												<rich:panel styleClass="tiletable"
													...
													<rich:dataTable id="sampleData" rows="#{GlobalVars.EPS_DATATABLE_MAX}"
														value="#{LangueSearchBB.criteria}" var="event"
														binding="#{LangueSearchBB.datable}"   sortMode="single"
														...
														<rich:column headerClass="dataTableHeader" sortable="true"
															sortBy="#{event.langueCode}"
															filterBy="#{event.langueCode}" filterEvent="onblur"
															styleClass="tile">

															<f:facet name="header">
																<h:outputText value="#{msg.langueParam_LangueCode}" />
															</f:facet>
															<h:commandLink styleClass="tableCommandLink"
																actionListener="#{LangueSearchBB.selectId}"
																action="#{LangueSearchBB.forwardModify}">
																<h:inputText value="#{event.langueCode}"
														...
														<rich:column sortBy="#{event.wording}"
															...
															<h:commandLink styleClass="tableCommandLink"
																...
																styleClass="inputTextWording2" readonly="true" size="35" />
															</h:commandLink>

														</rich:column>
														<rich:column sortBy="#{event.languageEmvCode}"
															filterBy="#{event.languageEmvCode}" filterEvent="onblur"
															sortable="true">
															<f:facet name="header">
																<h:outputText value="#{msg.Gen_emv_langue}" />
															</f:facet>
															<h:inputText value="#{event.languageEmvCode}"
							...
							<table width="100%" class="buttonPanel">
								...
								<tr>
									...
									<td align="left"><h:commandButton value="Back"
										action="#{LangueSearchBB.backToWelcomPage}"
										image="../../../images/button_back.png" immediate="true"></h:commandButton></td>
									<td align="left"><h:commandButton value="Add"
										action="#{LangueSearchBB.addRecord}"
										image="../../../images/button_add.png"></h:commandButton></td>
									<h:outputText value="#{LangueSearchBB.alertMsg}" escape="false"
										rendered="#{LangueSearchBB.render}" />
								</tr>
