										...
										<table width="100%" border="0">
											...
											<tr>
												<td class="instance" width="20%"><h:outputText
													value="#{msg.Gen_MccCode}" /></td>
												<td width="30%"><h:inputText id="center_code"
													value="#{MccSearchBB.mccCode}" size="4" maxlength="4">
												...
												<td width="30%"><h:inputText
													value="#{MccSearchBB.wording}" size="30" maxlength="30"></h:inputText></td>
											...
											<tr>
												<td width="60%"></td>
												<td align="left" ><h:commandButton value="Refresh" action="#{MccSearchBB.Refresh}" image="#{facesContext.externalContext.requestContextPath}/images/button_refresh.png"></h:commandButton></td>
												<td align="left" ><h:commandButton value="Search" action="#{MccSearchBB.search}" image="#{facesContext.externalContext.requestContextPath}/images/button_search.png"></h:commandButton></td>
											</tr>
										</table>
										...
										<td align="center">
											...
											<h:panelGrid border="1" columns="1" width="#{GlobalVars.EPS_DATATABLE_SIZE}"
												...
												<rich:dataTable id="sampleData" rows="#{GlobalVars.EPS_DATATABLE_MAX}"
													value="#{MccSearchBB.criteria}" var="event"
													binding="#{MccSearchBB.datable}"
													sortMode="single" 
													columnsWidth="0*"
													...
													<rich:column headerClass="dataTableHeader" sortable="true"
														sortBy="#{event.id.mccCode}" filterBy="#{event.id.mccCode}"
														...
														<h:commandLink styleClass="tableCommandLink"
															actionListener="#{MccSearchBB.selectId}"
															action="#{MccSearchBB.forwardModify}">
															
															<h:inputText value="#{event.id.mccCode}"  styleClass="inputTextLink" readonly="true" />
														</h:commandLink>
													</rich:column>
													...
													<rich:column headerClass="dataTableHeader" sortable="true" sortBy="#{event.wording}" 
														...
														<h:commandLink styleClass="tableCommandLink"
															actionListener="#{MccSearchBB.selectId}"
															action="#{MccSearchBB.forwardModify}">
														<h:inputText value="#{event.wording}"  styleClass="inputTextLink" readonly="true" size="35" />
														</h:commandLink>
													</rich:column>
													...
													<rich:column sortable="true" sortBy="#{event.id.networkCode}" 
														...
														<f:facet name="header">
															<h:outputText value="#{msg.Gen_networkCode}" />
														</f:facet>
													...
													<rich:column sortable="true" sortBy="#{event.tccCode}"
														filterBy="#{event.tccCode}" filterEvent="onblur">
														<f:facet name="header">
															<h:outputText value="#{msg.Gen_Tcc_Code}"/>
														</f:facet>
														<h:inputText styleClass="inputTextWording2" value="#{event.libelle}"  readonly="true"/>
													</rich:column>
							...
							<table width="100%" class="buttonPanel" border="0">
								...
								<tr>
									...
									<td align="left" ><h:commandButton value="Back"
										action="#{MccSearchBB.backToWelcomPage}"
									...
									<td align="left" ><h:commandButton value="Add"
										action="#{MccSearchBB.addRecord}"
										image="#{facesContext.externalContext.requestContextPath}/images/button_add.png"></h:commandButton></td>
									<h:outputText value="#{MccSearchBB.alertMsg}"
										 escape="false"
										rendered="#{MccSearchBB.render}" />
								</tr>
