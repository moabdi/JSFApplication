										...
										<table width="100%">
											<tr>
												<td class="instance" width="20%"><h:outputText
													value="#{msg.Funtion_code}" /></td>
												<td width="30%"><h:inputText id="processing_code"
													value="#{functionSearchBB.functionCode}" size="2" maxlength="2">
												...
												<td width="30%"><h:inputText value="#{functionSearchBB.wording}"
											...
											<tr>
												<td width="60%"></td>
												<td align="left" ><h:commandButton value="Refresh" action="#{functionSearchBB.Refresh}" image="#{facesContext.externalContext.requestContextPath}/images/button_refresh.png"></h:commandButton></td>
												<td align="left" ><h:commandButton value="Search" action="#{functionSearchBB.search}" image="#{facesContext.externalContext.requestContextPath}/images/button_search.png"></h:commandButton></td>
											</tr>
										</table>
										</td>
									</tr>
								...
								<tbody>
									<tr>
										...
										<td align="center">	<h:panelGrid border="1" columns="1" width="#{GlobalVars.EPS_DATATABLE_SIZE}"
												...
												<rich:dataTable id="sampleData" rows="#{GlobalVars.EPS_DATATABLE_MAX}" value="#{functionSearchBB.criteria}" var="event"
													binding="#{functionSearchBB.datable}"
													sortMode="single"
													...
													<rich:column headerClass="dataTableHeader" sortable="true"
														sortBy="#{event.functionCode}"
														filterBy="#{event.functionCode}" filterEvent="onblur"
														styleClass="tile" >

														<f:facet name="header">
															<h:outputText
																value="#{msg.Funtion_code}" />
														</f:facet>
														<h:commandLink styleClass="tableCommandLink"
															actionListener="#{functionSearchBB.selectId}"
															action="#{functionSearchBB.forwardModify}">
															<h:inputText value="#{event.functionCode}"
							...
							<table width="100%" class="buttonPanel">
								...
								<tr>
									...
									<td align="left"><h:commandButton value="Back"
										action="#{functionSearchBB.backToWelcomPage}"
									...
									<td align="left"><h:commandButton value="Add"
										action="#{functionSearchBB.addRecord}"
										image="#{facesContext.externalContext.requestContextPath}/images/button_add.png"></h:commandButton></td>
									<h:outputText value="#{functionSearchBB.alertMsg}"
										escape="false" rendered="#{functionSearchBB.render}" />
								</tr>
