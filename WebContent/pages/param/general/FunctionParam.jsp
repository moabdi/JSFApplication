			...
			<table class="titrePage" width="50%">
							...
							<table width="100%" class="ident">
								<tr>
									<td width="54%" align="left"><h:outputText
										value="#{msg.Funtion_table}" /></td>
									<td width="40%" align="right"><h:outputText
										value="#{msg.Funtion_add}"
										rendered="#{functionBean.addStatus}" /> <h:outputText
										value="#{msg.Funtion_modify}"
										rendered="#{functionBean.modifyStatus}" /></td>
									<td width="1%">&nbsp;</td>
								</tr>
							</table>
							</td>
										...
										<table width="100%">
											<tr>
												<td class="instance" width="20%"><h:outputText
													value="#{msg.Funtion_code}" /><h:outputLabel
														style="color:red" value="#{msg.Gen_RequireField}" /></td>
												<td width="30%"><h:inputText id="processing_code" required="true" requiredMessage="#{msg.Funtion_code} #{msg.Gen_required}"
													value="#{functionBean.functionCode}"
													disabled="#{functionBean.modifyStatus}" size="3"
													maxlength="3">

													<rich:ajaxValidator event="onblur" />
												</h:inputText> 
												<rich:message for="processing_code"	styleClass="warnningMessage" />
												</td>
												<td class="instance" width="20%"><h:outputText
													value="#{msg.Gen_Wording}" /> <h:outputLabel style="color:red"
													value="#{msg.Gen_RequireField}" /></td>
												<td width="30%"><h:inputText value="#{functionBean.wording}" size="32" required="true" 
												requiredMessage="#{msg.Gen_Wording} #{msg.Gen_required}" maxlength="32" id="wordin">
													<rich:ajaxValidator event="onblur" />
													</h:inputText>
				...
				<table width="100%">
					...
					<table width="100%" class="buttonPanel">
						<tr>
							...
							<td><a4j:commandButton value="Validate"
								...
								<a4j:poll id="poll" ajaxSingle="true"
									action="#{functionSearchBB.back}"
									oncomplete="Richfaces.hideModalPanel('validatePanel')"
									interval="2000" enabled="#{functionBean.pollEnabled}"
						...
						<h:outputText value="#{functionBean.alertMsg}"
							escape="false" rendered="#{functionBean.render}" />
					</table>
				...
				<table width=100% class="tile" align="center">
					...
					<tr>
						...
						<td align="center" width="50%"><h:commandButton
							value="#{msg.Gen_yes}" action="#{functionSearchBB.back}"
			...
			<h:form>
				...
				<table class="tile" width=100%>
					...
					<tr>
						<br>
						<td align="center" width="50%"><a4j:commandButton
							value="#{msg.Gen_yes}" action="#{functionBean.delete}"
