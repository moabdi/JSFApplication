			...
			<table class="titrePage" width="50%">
							...
							<table width="100%" class="ident">
								<tr>
									<td width="54%" align="left"><h:outputText
										value="#{msg.online_event_table}" /></td>
									<td width="40%" align="right"><h:outputText
										value="#{msg.online_event_add}"
										rendered="#{onlineEventBean.addStatus}" /> <h:outputText
										value="#{msg.online_event_modify}"
										rendered="#{onlineEventBean.modifyStatus}" /></td>
									<td width="1%">&nbsp;</td>
								</tr>
							</table>
							</td>
										...
										<table width="100%">
											<tr>
												<td class="instance" width="20%"><h:outputText
													value="#{msg.online_event_code}" /><h:outputLabel
														style="color:red" value="#{msg.Gen_RequireField}" /></td>
												<td width="30%">
												<h:inputText id="trx_code" required="true" requiredMessage="#{msg.online_event_code} #{msg.Gen_required}"
													value="#{onlineEventBean.eventCode}" disabled="#{onlineEventBean.modifyStatus}" size="3" maxlength="3">
												...
												<td width="30%"><h:inputText id="wordin" value="#{onlineEventBean.wording}" size="30" required="true" 
				...
				<table width="100%">
					...
					<table width="100%" class="buttonPanel">
						<tr>
							...
							<td><a4j:commandButton value="Validate"
								...
								<a4j:poll id="poll" ajaxSingle="true"
									action="#{onlineEventSearchBB.back}"
									oncomplete="Richfaces.hideModalPanel('validatePanel')"
									interval="2000" enabled="#{onlineEventBean.pollEnabled}"
						...
						<h:outputText value="#{onlineEventBean.alertMsg}"
							escape="false" rendered="#{onlineEventBean.render}" />
					</table>
				...
				<table width=100% class="tile" align="center">
					...
					<tr>
						...
						<td align="center" width="50%"><h:commandButton
							value="#{msg.Gen_yes}" action="#{onlineEventSearchBB.back}"
			...
			<h:form>
				...
				<table class="tile" width=100%>
					...
					<tr>
						<br>
						<td align="center" width="50%"><a4j:commandButton
							value="#{msg.Gen_yes}" action="#{onlineEventBean.delete}"
