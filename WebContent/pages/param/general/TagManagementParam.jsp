							...
							<table width="100%" class="ident">
								<tr>
									...
									<td width="40%" align="right"><h:outputText
										value="#{msg.Gen_Add}" rendered="#{TagManagementBB.addStatus}" />
									<h:outputText value="#{msg.Gen_Modify}"
										rendered="#{TagManagementBB.modifyStatus}" /></td>
									<td width="1%">&nbsp;</td>
								</tr>
							</table>
							</td>
										...
										<table width="100%">
											<tr>
												<td class="instance" width="20%"><h:outputText
													value="#{msg.tagCode}" /><h:outputLabel
														style="color:red" value="#{msg.Gen_RequireField}" /></td>
												<td width="30%"><h:inputText id="tagC"
													value="#{TagManagementBB.tagCode}"
													disabled="#{TagManagementBB.modifyStatus}" size="5"
													maxlength="5">

													<rich:ajaxValidator event="onblur" />
												</h:inputText> <rich:message for="tagC" styleClass="warnningMessage" /></td>
												<td class="instance" width="20%"><h:outputText
													value="#{msg.tagName}" /><h:outputLabel style="color:red"
													value="#{msg.Gen_RequireField}" /></td>
												<td width="30%"><h:inputText required="true" requiredMessage="#{msg.Gen_wording} #{msg.Gen_required}"
													value="#{TagManagementBB.tagName}" size="30" maxlength="30"></h:inputText></td>
											<tr>
										</table>
										</td>
									</tr>
						...
						<tr>
							...
							<td><a4j:commandButton value="Validate"
								...
								<a4j:poll id="poll" ajaxSingle="true"
									action="#{TagManagementSearch.back}"
									oncomplete="Richfaces.hideModalPanel('validatePanel')"
									interval="2000" enabled="#{TagManagementBB.pollEnabled}"
				...
				<table width=100% class="tile" align="center">
					...
					<tr>
						...
						<td align="center" width="50%"><h:commandButton
							value="#{msg.Gen_yes}" action="#{TagManagementSearch.back}"
			...
			<h:form>
				...
				<table class="tile" width=100%>
					...
					<tr>
						<br>
						<td align="center" width="50%"><a4j:commandButton
							value="#{msg.Gen_yes}" action="#{TagManagementBB.delete}"
