							...
							<table width="100%" class="ident">
								<tr>
									...
									<td width="40%" align="right"><h:outputText
										value="#{msg.currencyCountryParam_addCurrencyCountry}"
										rendered="#{currencyCountryBackingBean.addStatus}" /> <h:outputText
										value="#{msg.currencyCountryParam_modifyCurrencyCountry}"
										rendered="#{currencyCountryBackingBean.modifyStatus}" /></td>
									<td width="1%">&nbsp;</td>
								</tr>
							</table>
							</td>
								...
								<tbody>
									<tr>
										...
										<table width="100%">
											...
											<td width="30%"><h:inputText id="Country_code" required="true" requiredMessage="#{msg.Gen_CountryCode} #{msg.Gen_required}"
												value="#{currencyCountryBackingBean.countryCode}"
												disabled="#{currencyCountryBackingBean.modifyStatus}"
												size="3" maxlength="3">

												<rich:ajaxValidator event="onblur" />
											</h:inputText> <rich:message for="Country_code"
												styleClass="warnningMessage" /></td>
											</tr>
											<tr>
												<td class="instance" width="20%"><h:outputText
													value="#{msg.currencyCountryParam_CurrencyCountryCode}" /><h:outputLabel
												style="color:red" value="#{msg.Gen_RequireField}" /></td>
												<td width="30%"><h:inputText id="currencyCountry_code"
													value="#{currencyCountryBackingBean.currencyCode}" required="true" requiredMessage="#{msg.currencyCountryParam_CurrencyCountryCode} #{msg.Gen_required}"
													disabled="#{currencyCountryBackingBean.modifyStatus}"
													size="3" maxlength="3">

													<rich:ajaxValidator event="onblur" />
												</h:inputText> 
												<rich:message for="currencyCountry_code" styleClass="warnningMessage" />
												</td>
												<td class="instance" width="20%"><h:outputText
												...
												<td width="30%"><h:inputText required="true" requiredMessage="#{msg.Gen_wording} #{msg.Gen_required}"
													value="#{currencyCountryBackingBean.wording}" size="30" id="wordin" maxlength="30">
													<rich:ajaxValidator event="onblur" />
													</h:inputText>
							...
							<tbody>
								<tr>
									...
									<table width="100%">
										<tr>
											<td class="instance" width="20%"><h:outputText
												value="#{msg.Gen_Exponent}" /><h:outputLabel
												style="color:red" value="#{msg.Gen_RequireField}" /></td>
											<td width="30%">
											<h:selectOneMenu required="true" requiredMessage="#{msg.Gen_Exponent} #{msg.Gen_required}" 
											value="#{currencyCountryBackingBean.exponent}" style="width: 50px;" >
											...
											<td class="instance" width="20%"><h:outputText
												value="#{msg.Gen_IsoCurrencyAplpha}"
												id="IsoCurrencyAplphaId" /><h:outputLabel
												style="color:red" value="#{msg.Gen_RequireField}" /></td>
											<td width="30%"><h:inputText required="true" requiredMessage="#{msg.Gen_IsoCurrencyAplpha} #{msg.Gen_required}"
												value="#{currencyCountryBackingBean.isoCurrencyAlpha}"
												size="3" maxlength="3">
												<rich:ajaxValidator event="onblur" />
											</h:inputText> <rich:message for="IsoCurrencyAplphaId"
												styleClass="warnningMessage" /></td>
										</tr>
										...
										<tr>
											...
											<td class="instance"><h:outputText
												value="#{msg.WordingCountry}" /><h:outputLabel
												style="color:red" value="#{msg.Gen_RequireField}" /></td>
											<td><h:inputText required="true" requiredMessage="#{msg.WordingCountry} #{msg.Gen_required}"
												value="#{currencyCountryBackingBean.wordingCountry}"
										...
										<tr>
											<td class="instance"><h:outputText
												value="#{msg.Gen_CountryLabelVisa}" /><h:outputLabel
												style="color:red" value="#{msg.Gen_RequireField}" /></td>
											<td><h:inputText required="true" requiredMessage="#{msg.Gen_CountryLabelVisa} #{msg.Gen_required}"
												value="#{currencyCountryBackingBean.countryLabelVisa}"
												id="countryLabelVisaId" size="3" maxlength="2">

												<rich:ajaxValidator event="onblur" />
											</h:inputText> <rich:message for="countryLabelVisaId"
												styleClass="warnningMessage" /></td>
											<td class="instance"><h:outputText
												value="#{msg.Gen_IsoCountryAlpha}" /><h:outputLabel
												style="color:red" value="#{msg.Gen_RequireField}" /></td>
											<td><h:inputText required="true" requiredMessage="#{msg.Gen_IsoCountryAlpha} #{msg.Gen_required}"
												value="#{currencyCountryBackingBean.isoCountryAlpha}"
												id="isoCountryAlphaId" size="3" maxlength="3">
												<rich:ajaxValidator event="onblur" />
											</h:inputText> <rich:message for="isoCountryAlphaId"
												styleClass="warnningMessage" /></td>
										</tr>
									</table>
									</td>
						...
						<table width="100%" class="buttonPanel">
							<tr>
								...
								<td><a4j:commandButton value="Back"
									actionListener="#{currencyCountryBackingBean.checkChanges}"
									action="#{currencyCountryBackingBean.back}"
									oncomplete="#{currencyCountryBackingBean.backPanel}"
									image="#{facesContext.externalContext.requestContextPath}/images/button_back.png"
									immediate="#{currencyCountryBackingBean.immediate}"></a4j:commandButton></td>

								<td><h:commandButton value="Add"
									action="#{currencyCountryBackingBean.ToAddRecord}"
									image="#{facesContext.externalContext.requestContextPath}/images/button_add.png"
									rendered="#{currencyCountryBackingBean.modifyStatus}">
								</h:commandButton></td>
								<td><h:commandButton value="Duplicate"
									action="#{currencyCountryBackingBean.ToDuplicateRecord}"
									image="#{facesContext.externalContext.requestContextPath}/images/button_duplicate.png"
									rendered="#{currencyCountryBackingBean.modifyStatus}">
								</h:commandButton></td>
								<td><h:commandButton value="Refresh"
									action="#{currencyCountryBackingBean.refresh}"
									image="#{facesContext.externalContext.requestContextPath}/images/button_refresh.png"
									rendered="#{currencyCountryBackingBean.addStatus}">
								...
								<td><a4j:commandButton value="Validate"
									...
									<a4j:poll id="poll" ajaxSingle="true"
										action="#{currencyCountrySearchBB.back}"
										oncomplete="Richfaces.hideModalPanel('validatePanel')"
										interval="2000"
										enabled="#{currencyCountryBackingBean.pollEnabled}"
				...
				<table width=100% class="tile" align="center">
					...
					<tr>
						...
						<td align="center" width="50%"><h:commandButton
							value="#{msg.Gen_yes}" action="#{currencyCountrySearchBB.back}"
			...
			<h:form>
				...
				<table class="tile" width=100%>
					...
					<tr>
						...
						<td align="center" width="50%"><a4j:commandButton
							value="#{msg.Gen_yes}"
							action="#{currencyCountryBackingBean.delete}"
