...
<h:form>
	...
	<h:form>
							...
							<table width="100%" class="ident">
								<tr>
									...
									<td width="40%" align="right"><h:outputText
										value="#{msg.processingParam_searchProcessing}" /></td>
									<td width="1%">&nbsp;</td>
								</tr>
										...
										<table width="100%">
											<tr>
												<td class="instance" width="20%"><h:outputText
													value="#{msg.processingParam_ProcessingCode}" /></td>
												<td width="30%"><h:inputText id="processing_code"
													value="#{processingSearchBB.processingCode}" size="2" maxlength="2">
												...
												<td width="30%"><h:inputText value="#{processingSearchBB.wording}"
											...
											<h:commandButton value="Refresh"
													action="#{processingSearchBB.Refresh}"
												...
												<td align="left"><h:commandButton value="Search"
													action="#{processingSearchBB.search}"
								...
								<tbody>
									<tr>
										...
										<td align="center">	<h:panelGrid border="1" columns="1" width="#{GlobalVars.EPS_DATATABLE_SIZE}"
												...
												value="#{processingSearchBB.criteria}" var="event"
													binding="#{processingSearchBB.datable}"
													sortMode="single"
													...
													<rich:column headerClass="dataTableHeader" sortable="true"
														sortBy="#{event.processingCode}"
														filterBy="#{event.processingCode}" filterEvent="onblur"
														styleClass="tile" >

														<f:facet name="header">
															<h:outputText
																value="#{msg.processingParam_ProcessingCode}" />
														</f:facet>
														<h:commandLink styleClass="tableCommandLink"
															actionListener="#{processingSearchBB.selectId}"
															action="#{processingSearchBB.forwardModify}">
															<h:inputText value="#{event.processingCode}"
													...
													<rich:column sortBy="#{event.wording}"
														...
														<f:facet name="header">
															...
															<h:inputText value="#{event.wording}"
																styleClass="inputTextWording2" readonly="true"  size="32" />
							...
							<table width="100%" class="buttonPanel">
								...
								<tr>
									...
									<td align="left"><h:commandButton value="Back"
										action="#{processingSearchBB.backToWelcomPage}"
									...
									<td align="left"><h:commandButton value="Add"
										action="#{processingSearchBB.addRecord}"
										image="#{facesContext.externalContext.requestContextPath}/images/button_add.png"></h:commandButton></td>
									<h:outputText value="#{processingSearchBB.alertMsg}"
										escape="false" rendered="#{processingSearchBB.render}" />
								</tr>
		...
		</table></td></tr></tbody></table></td></tr></table></td></tr></table></table></h:form>
	</body>
