							...
							<table width="100%" class="ident">
								<tr>
									...
									<td width="40%" align="right"><h:outputText
										value="#{msg.centerParam_addCenter}"
										rendered="#{centerBackingBean.addStatus}" /> <h:outputText
										value="#{msg.centerParam_modifyCenter}"
										rendered="#{centerBackingBean.modifyStatus}" /></td>
									<td width="1%">&nbsp;</td>
								</tr>
							</table>
							</td>
										...
										<table width="100%">
											<tr>
												<td class="instance" width="20%"><h:outputText
													value="#{msg.centerParam_CenterCode}" /><h:outputLabel
													style="color:red" value="#{msg.Gen_RequireField}" /></td>
												<td width="30%"><h:inputText id="center_code" required="true" requiredMessage="#{msg.centerParam_CenterCode} #{msg.Gen_required}"
													value="#{centerBackingBean.centerCode}"
													disabled="#{centerBackingBean.modifyStatus}" size="2"
													maxlength="2">
													<f:validator validatorId="mustBeNumber" />
													<rich:ajaxValidator event="onblur" />
												</h:inputText> <rich:message for="center_code"
												...
												<td width="30%"><h:inputText required="true" requiredMessage="#{msg.Gen_wording} #{msg.Gen_required}"
													value="#{centerBackingBean.wording}" size="30"
								...
								<tbody>
									<tr>
										...
										<table width="100%">
											<tr>
												<td class="instance" width="20%"><h:outputText
													value="#{msg.Gen_CenterType}" /><h:outputLabel
													style="color:red" value="#{msg.Gen_RequireField}" /></td>
												<td width="80%"><h:selectOneMenu  required="true" requiredMessage="#{msg.Gen_CenterType} #{msg.Gen_required}"
													value="#{centerBackingBean.centerType}" id="center_type">
													<f:selectItem itemLabel="#{msg.Gen_Select}" />
													<f:selectItems value="#{centerBackingBean.centerTypeList}"/>
													<rich:ajaxValidator event="onblur" />
													<a4j:support event="onchange" ajaxSingle="true" reRender="lbl_processCode"/>
												</h:selectOneMenu><a4j:support event="onchange" reRender="lbl_processCode"></a4j:support>
												<rich:message for="center_type" styleClass="warnningMessage" />
												</td>
							...
							<table width="100%" class="buttonPanel">
								...
								<tr>
									...
									<td><a4j:commandButton value="Back"
										actionListener="#{centerBackingBean.checkChanges}"
										action="#{centerBackingBean.back}"
										oncomplete="#{centerBackingBean.backPanel}"
										image="#{facesContext.externalContext.requestContextPath}/images/button_back.png"
										immediate="#{centerBackingBean.immediate}"></a4j:commandButton></td>

									<td><h:commandButton value="Add"
										action="#{centerBackingBean.ToAddRecord}"
										image="#{facesContext.externalContext.requestContextPath}/images/button_add.png"
										rendered="#{centerBackingBean.modifyStatus}">
										<a4j:support action="#{centerBackingBean.chargement}" immediate="true"></a4j:support>
									</h:commandButton>
									</td>

									<td><h:commandButton value="Duplicate"
										action="#{centerBackingBean.ToDuplicateRecord}"
									...
									<td><h:commandButton value="Refresh"
										action="#{centerBackingBean.refresh}"
										image="../../../images/button_refresh.png"
										rendered="#{centerBackingBean.addStatus}"></h:commandButton></td>
									...
									<td><a4j:commandButton value="Validate"
										...
										rendered="#{centerBackingBean.addStatus}"
										action="#{centerBackingBean.valider}"
										reRender="poll2,validatePanel,msg" 
										status="status_validate"></a4j:commandButton> <a4j:commandButton
										value="Modify" action="#{centerBackingBean.modify}"
										reRender="poll2,validatePanel,msg" 
										...
										<a4j:poll id="poll" ajaxSingle="true"
											action="#{centerSearchBB.back}"
											oncomplete="Richfaces.hideModalPanel('validatePanel')"
											interval="2000" enabled="#{centerBackingBean.pollEnabled}"
				...
				<table width=100% class="tile" align="center">
					...
					<tr>
						...
						<td align="center" width="50%"><h:commandButton
							value="#{msg.Gen_yes}" action="#{centerSearchBB.back}"
			...
			<h:form>
				...
				<table class="tile" width=100%>
					...
					<tr>
						<br>
						<td align="center" width="50%"><a4j:commandButton
							value="#{msg.Gen_yes}" action="#{centerBackingBean.delete}"
