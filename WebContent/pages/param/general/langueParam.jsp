							...
							<table width="100%" class="ident">
								<tr>
									<td width="54%" align="left"><h:outputText
										value="#{msg.Gen_lang}" /></td>
									<td width="40%" align="right"><h:outputText
										value="#{msg.Gen_Add}"
										rendered="#{LangueBakingBean.addStatus}" /> <h:outputText
										value="#{msg.Gen_Modify}"
										rendered="#{LangueBakingBean.modifyStatus}" /></td>
									<td width="1%">&nbsp;</td>
								</tr>
							</table>
							</td>
										...
										<table width="100%">
											<tr>
												<td class="instance" width="20%"><h:outputText
													value="#{msg.Gen_code}" /><h:outputLabel
														style="color:red" value="#{msg.Gen_RequireField}" /></td>
												<td width="30%"><h:inputText id="langue_code"  required="true"
												requiredMessage="#{msg.langueParam_LangueCode} #{msg.Gen_required} "
													value="#{LangueBakingBean.langueCode}"
													disabled="#{LangueBakingBean.modifyStatus}" size="3"
													maxlength="3">

													<rich:ajaxValidator event="onblur" />
												</h:inputText> 
												<rich:message for="langue_code"	styleClass="warnningMessage" />
												</td>
												<td class="instance" width="20%"><h:outputText
													value="#{msg.Gen_Wording}" /> <h:outputLabel style="color:red"
													value="#{msg.Gen_RequireField}" /></td>
												<td width="30%"><h:inputText value="#{LangueBakingBean.wording}" id="wordin"
												...
												<tr>
												<td class="instance" width="20%"><h:outputText
													value="#{msg.Gen_emv_langue}" /> </td>
												<td width="30%"><h:inputText value="#{LangueBakingBean.languageEmvCode}"
												size="2" maxlength="2" >
												</h:inputText></td>
												</tr>
											<tr>
					...
					<table width="100%" class="buttonPanel">
						<tr>
							...
							<td><a4j:commandButton value="Back"
								actionListener="#{LangueBakingBean.checkChanges}"
								action="#{LangueBakingBean.back}"
								oncomplete="#{LangueBakingBean.backPanel}"
								image="#{facesContext.externalContext.requestContextPath}/images/button_back.png"
								immediate="#{LangueBakingBean.immediate}"></a4j:commandButton></td>

							<td><h:commandButton value="Add"
								action="#{LangueBakingBean.ToAddRecord}"
								image="#{facesContext.externalContext.requestContextPath}/images/button_add.png"
								rendered="#{LangueBakingBean.modifyStatus}">
							</h:commandButton></td>

							<td><h:commandButton value="Duplicate"
								action="#{LangueBakingBean.ToDuplicateRecord}"
							...
							<td><a4j:commandButton value="Validate"
								...
								<a4j:poll id="poll" ajaxSingle="true"
									action="#{LangueSearchBB.back}"
									oncomplete="Richfaces.hideModalPanel('validatePanel')"
									interval="2000" enabled="#{LangueBakingBean.pollEnabled}"
				...
				<table width=100% class="tile" align="center">
					...
					<tr>
						...
						<td align="center" width="50%"><h:commandButton
							value="#{msg.Gen_yes}" action="#{LangueSearchBB.back}"
			...
			<h:form>
				...
				<table class="tile" width=100%>
					...
					<tr>
						<br>
						<td align="center" width="50%"><a4j:commandButton
							value="#{msg.Gen_yes}" action="#{LangueBakingBean.delete}"
