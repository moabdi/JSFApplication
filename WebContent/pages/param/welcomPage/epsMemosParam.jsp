								...
								<table width="100%" class="ident">
									<tr>
										...
										<td width="40%" align="right"><h:outputText
											value="#{msg.Gen_Eps_Memos_Add}"
											rendered="#{epsMemosBB.addStatus}" /> <h:outputText
											value="#{msg.Gen_Eps_Memos_Modify}"
											rendered="#{epsMemosBB.modifyStatus}" /></td>
										<td>&nbsp;</td>
									</tr>
								</table>
								</td>
										...
										<tr>
											...
											<table width="100%">
												...
												<tr>
													...
													<td class="instance" width="20%"><h:outputLabel value="#{msg.User_code}" />
														<h:outputLabel style="color:red" value="#{msg.Gen_RequireField}" /></td>
													<td width="30%">
													<h:selectOneMenu id="userCode" disabled="#{epsMemosBB.modifyStatus}"
														value="#{epsMemosBB.userCode}" required="true" requiredMessage="#{msg.User_code} #{msg.Gen_required}">
														<f:selectItem itemLabel="#{msg.Gen_Select}" itemValue="" />
														<f:selectItems value="#{epsMemosBB.userlistSI}" />
														<a4j:support event="onchange" ajaxSingle="true" reRender="lbl_usercode" />
														<rich:ajaxValidator event="onblur"></rich:ajaxValidator>
													</h:selectOneMenu>
													<h:outputLabel styleClass="codelbl" id="lbl_usercode" value="#{epsMemosBB.userCode}" /> 
													<rich:message for="userCode" styleClass="warnningMessage" />
													</td>


													<td class="instance" width="20%"><h:outputText value="#{msg.GEN_SUBJECT}" />
														<h:outputLabel style="color:red" value="#{msg.Gen_RequireField}" />
														</td>
													<td width="30%">
													<h:inputText id="subject"
														autocomplete="off" required="true" requiredMessage="#{msg.GEN_SUBJECT} #{msg.Gen_required}"
														value="#{epsMemosBB.subject}" disabled="#{epsMemosBB.modifyStatus}">
														<rich:ajaxValidator event="onblur"></rich:ajaxValidator>
													...
													<td class="instance" width="20%"><h:outputText
														value="#{msg.Gen_Execution_Date}" /></td>
													<td width="30%">
													<rich:calendar value="#{epsMemosBB.executionDate}" id="messageDate">
													</rich:calendar>
													</td>
											...
											<table class="tile" width="100%">
												...
												<tr>
													...
													<td width="30%"><h:inputTextarea id="details" value="#{epsMemosBB.details}" >
													</h:inputTextarea>
													</td>
						...
						<table width="100%" class="buttonPanel">
							<tr>
								...
								<td><a4j:commandButton value="Back"
									actionListener="#{epsMemosBB.checkChanges}"
									action="#{epsMemosBB.back}"									
									reRender="backPanel,validatePanel,msg" immediate="true"
									oncomplete="#{epsMemosBB.backPanel}"
								...
								<td><h:commandButton value="Refresh" immediate="true"
									...
									rendered="#{epsMemosBB.modifyStatus}">
								...
								<td><a4j:commandButton value="Validate" onclick="vModif='allBean,exit';"
									...
									<a4j:poll id="poll" ajaxSingle="true"
										action="#{epsMemosSearchBB.back}"
										oncomplete="Richfaces.hideModalPanel('validatePanel')"
										interval="2000"
										enabled="#{epsMemosBB.pollEnabled}"
