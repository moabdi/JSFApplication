																...
																<table width="100%">
																	<tr>
																		...
																		<td width="30%"><h:inputText
																			value="#{customerParamSearch.msisdn}" size="10" maxlength="10"></h:inputText></td>
																		<td class="instance" width="10%"><h:outputLabel> Email </h:outputLabel></td>
																		<td width="30%"><h:inputText
																			value="#{customerParamSearch.email}" size="30" maxlength="30"></h:inputText></td>
																	</tr>
																	<tr>
																		<table width="100%">
																			<tr>
																	...
																	<tr>
																		<td align="center"><h:panelGrid border="1" columns="1"
																			...
																			<rich:dataTable id="sampleData" rows="#{GlobalVars.EPS_DATATABLE_MAX}"
																					value="#{customerParamSearch.criteria}" var="event"
																					binding="#{customerParamSearch.datable}"
																			...
																			<rich:column headerClass="dataTableHeader" sortable="true"
																				...
																				<f:facet name="header">
																					...
																					<h:commandLink styleClass="tableCommandLink"
																						actionListener="#{customerParamSearch.selectId}"
																						action="#{customerParamSearch.forwardModify}">
										...
										<table width="100%" class="buttonPanel">
											<tr>
												...
												<td align="left"><h:commandButton value="Back"
													action="#{customerParamSearch.backToWelcomPage}"
													image="/images/button_back.png" immediate="true"></h:commandButton></td>
												<td align="left"><h:commandButton value="Add"
													action="#{customerParamSearch.addRecord}"
													image="/images/button_add.png"></h:commandButton></td>
														<h:outputText value="#{customerParamSearch.alertMsg}"
															escape="false" rendered="#{customerParamSearch.render}" />
											</tr>
										</table>
									</td>
								</tr>
