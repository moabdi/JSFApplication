						...
						<tr>
							...
							<td>
								<h:commandButton value="Duplicate"
									action="#{customerBC.ToDuplicateRecord}"
							...
							<td>
								<h:commandButton value="Refresh"
									action="#{customerBC.refresh}"
									image="/images/button_refresh.png"
									rendered="#{customerBC.addStatus}"  >
								</h:commandButton>
